        ...
        <div class="grid grid-cols-1 lg:grid-cols-2 md:h-screen">
            <div
                ...
                <div class="absolute inset-0">
                    <img class="object-cover object-top w-full h-full" src="{{ asset('images/login.jpg') }}"
                        alt="" />
                </div>
            ...
            <div class="flex items-center justify-center px-4 py-10 bg-white sm:px-6 lg:px-8 sm:py-16 lg:py-24">
                <div class="xl:w-full xl:max-w-sm 2xl:max-w-md xl:mx-auto">
                    ...
                    <p class="mt-2 text-base text-gray-600">Vous n'avez pas un compte? <a href="{{ route('register') }}"
                            title=""
                    ...
                    <form action="{{ route('login') }}" method="POST" class="mt-8">
                        ...
                        <p class="alert mt-2 text-sm text-red-600">
                            @if (session('error'))
                                {{ session('error') }}
                            @endif
                        </p>
